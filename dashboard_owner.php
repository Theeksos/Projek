...
<head>
    <meta charset="UTF-8">
    <title>Dashboard Owner - Dough & Co Hub</title>
...
<body class="p-5" style="background:#FDF2F8;">
    <div class="container">
        ...
        <p>Ini halaman placeholder dashboard owner. Silakan dikembangkan sesuai fitur di makalah (Monitoring, Stok, dsb).</p>
